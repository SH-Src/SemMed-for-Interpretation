...
cui2id, id2cui, relation2id, id2relation = load_resources("../data/semmed/entity2id.txt")
semmed_simple, semmed = load_semmed("../data/semmed/database.graph")
...
def generate_adj_data_from_grounded_concepts(grounded_path, output_path):
    """
    ...
    # with Pool(2) as p:
    #     res = list(tqdm(p.imap(concepts_to_adj_matrices_3hop_all_pair, qa_data), total=len(qa_data)))
    res = []
...
if __name__ == "__main__":
    ...
    generate_adj_data_from_grounded_concepts("../data/hfdata/grounded/dev_ground.jsonl", "../data/hfdata/graph/dev_graph_adj.pk")
    generate_adj_data_from_grounded_concepts("../data/hfdata/grounded/train_ground.jsonl", "../data/hfdata/graph/train_graph_adj.pk")
    generate_adj_data_from_grounded_concepts("../data/hfdata/grounded/test_ground.jsonl", "../data/hfdata/graph/test_graph_adj.pk")
