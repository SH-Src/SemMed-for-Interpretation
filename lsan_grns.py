...
from modeling.modeling_lsan_grns import *
...
def main():
    ...
    parser.add_argument('--save_dir', default=f'./saved_models/lsan_grns/', help='model output directory')
    ...
    parser.add_argument('--ablation', default=['q2a_only', 'no_trans'], choices=['no_trans', 'early_relu', 'no_att', 'ctx_trans', 'q2a_only',
