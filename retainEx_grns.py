...
from modeling.modeling_retainEx_grns import *
...
def main():
    ...
    parser.add_argument('--save_dir', default=f'./saved_models/retainEx_grns/', help='model output directory')
    ...
    parser.add_argument('--ablation', default=['q2a_only', 'no_trans'],
...
def train(args):
    ...
    try:
        ...
        lstm_config = get_retainEx_config(args)
    ...
    for epoch_id in range(args.n_epochs):
        ...
        print('-' * 71)
        print('| step {:5} | train_acc {:7.4f} | dev_acc {:7.4f} | test_acc {:7.4f} | loss {:7.4f} '.format(global_step,
                                                                                                            train_acc,
                                                                                                            dev_acc,
                                                                                                            test_acc,
                                                                                                            tl))
