...
from modeling.modeling_gruself_grns import *
...
def main():
    ...
    parser.add_argument('--save_dir', default=f'./saved_models/gruself_grns/', help='model output directory')
...
def train(args):
    ...
    lstm_config = get_gruself_config(args)
